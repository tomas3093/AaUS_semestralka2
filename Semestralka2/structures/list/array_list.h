...
namespace structures
{
	...
	public:
		...
		/// <summary> Parametricky konstruktor s parametrom pociatocna velkost pola. </summary>
		ArrayList(size_t initAllocSize);
	...
	template<typename T>
	inline ArrayList<T>::ArrayList(size_t initAllocSize) :
		array_(new Array<T>(initAllocSize)),
		size_(0)
	{
	}
